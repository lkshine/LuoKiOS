...
- (void)layoutUI2 {
    ...
    [button addTarget:self
               action:@selector(loadImageWithMultiThread)//(loadImageWithMultiThreadWithInvacation)//(loadImageWithMultiThread2)
...
#pragma mark 将图片显示到界面 -- NSThread & NSInvocationOperation
...
#pragma mark 请求图片数据 -- NSThread & NSInvocationOperation
...
#pragma mark 加载图片 -- NSThread & NSInvocationOperation
